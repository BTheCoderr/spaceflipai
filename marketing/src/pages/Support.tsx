    ...
    >
      <Card className="contact-box">
        ...
        <p>
          ...
          {' '}for support requests, bug reports, or data deletion requests.
        </p>
        <p style={{ marginTop: '0.75rem', fontSize: '0.9rem' }}>
          Future support inbox: {siteConfig.supportEmailFuture}
        </p>
      </Card>
      ...
      <p style={{ marginTop: '1.5rem' }}>
        For data deletion instructions, see our{' '}
        <Link to="/delete-data">Delete Data page</Link>.
      </p>
    </PageShell>
  );
}
...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <p>
        No. Concept images are planning references only — not final renders or guaranteed
        design outcomes. Final design, pricing, and construction should be verified with
  ...
  },
  {
    ...
    answer: (
      <p>
        No. Payments and subscriptions are not active in the current MVP build. The app is in
        MVP testing mode.
      </p>
    ),
  },
  {
    ...
    answer: (
      <p>
        ...
        This removes the saved project record from your account data in the app backend.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        upgrades. It provides planning drafts — not licensed architectural, engineering, or
        legal advice.
      </p>
    ),
  },
